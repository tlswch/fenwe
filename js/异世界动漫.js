var rule={
    ...
    二级:{"title":"h2&&Text;li.data:eq(0)&&Text","img":".lazyload&&data-original","desc":"li.data:eq(1)&&Text;li.data:eq(2)&&Text;li.data:eq(3)&&Text","content":".module-info-introduction&&Text","tabs":".module-tab-item","lists":".module-play-list:eq(#id) a"},
